...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url("backend/".$route."/index");?>">All Video</a></li>
            ...
            <div class="row">
              ...
              <h3 class="box-title">New Post </h3>
                        ...
                        <div class="form-group">
                                <label class="exampleInputFile">Judul</label>
                                <input type="text" class="form-control" id="judul" name="judul" placeholder="Enter role name" value="<?php echo $row->judul; ?>">
                            </div>
                            <div class="form-group">
                                <label class="exampleInputFile">Link Video</label>
                                <input type="text" class="form-control" id="link" name="link" placeholder="Enter role name" value="<?php echo $row->link; ?>">
                            </div>
